...
def get_doc1_lines():
    ...
    return [
        # Page 1
        MockLine("no 12736/2003", page_num=1, y_rel=0.08),
...
def test_sequential_documents():
    ...
    assert result_a["stamp_purchase_date"] == "09-10-2003"
    ...
    assert "Raghavender" in vendor["name"] or "Sai Vishnu Developers" in vendor["name"], f"Doc B vendor failed: {vendor['name']}"
    ...
    assert result_b["stamp_purchase_date"] == "22-08-2024", f"Doc B stamp_date failed: {result_b['stamp_purchase_date']}"
    ...
    assert result_b["stamp_purchase_date"] != "09-10-2003", "FAIL: 09-10-2003 leaked into Doc B"
